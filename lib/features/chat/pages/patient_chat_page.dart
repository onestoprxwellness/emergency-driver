...
class PatientChatPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<ChatViewModel>.reactive(
      viewModelBuilder: () => ChatViewModel(chatType: ChatType.patient),
      ...
      builder: (context, viewModel, child) {
        return Scaffold(
          backgroundColor: const Color(0xFFF5FAFF), // Light blue background
          body: SafeArea(
            child: Column(
              children: [
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                if (message.isFromDriver) {
                  ...
                  return Padding(
                    padding: EdgeInsets.only(bottom: 8.v),
                    child: _buildPatientMessage(message.text, timeString),
                  );
                }
              },
            ),
  ...
  Widget _buildDriverMessage(String message, String time, String status) {
    return Align(
      ...
      child: Container(
        ...
        decoration: const BoxDecoration(
          color: Color(0x29077BF8), // Blue with alpha (rgba(7, 123, 248, 0.16))
  ...
  Widget _buildPatientMessage(String message, String time) {
    return Align(
      ...
      child: Container(
        ...
        padding: EdgeInsets.symmetric(horizontal: 12.h, vertical: 8.v),
        decoration: const BoxDecoration(
          color: Color(0x1A00264F), // Dark blue with alpha (rgba(0, 38, 79, 0.1))
          borderRadius: BorderRadius.only(
            topLeft: Radius.circular(14),
